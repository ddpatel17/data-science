...
print("np.logical_and(a1,a2) :",np.logical_and(a1,a2))
print("np.logical_and(a1<0,a2>3) :",np.logical_and(a1<0 , a1>3)) #[False, False, False, False, False]
print("np.logical_and(a1<0,a2>3) :",np.logical_and(a1>0 , a1<5)) #[True, True, True, False, True]
print("np.logical_and(a1<0,a2>3) :",np.logical_and(a1>0 , a2<5)) #[True, True, True, False, True]

# 2. Logical OR (True where at least one condition is True)
print("np.logical_or(a1,a2) :",np.logical_or(a1,a2))
...
print("np.logical_not(a1,a2) :",np.logical_not(a1 & a2)) 
print("np.logical_not(a1<0 , a1>3) :",np.logical_not(a1<0 & a1>3)) # [TRUE, TRUE, TRUE, TRUE, TRUE]
print("np.logical_not(a1>0 , a1<5) :",np.logical_not(a1>0 & a1<5)) # [FALSE, FALSE, FALSE, TRUE, TRUE]
...
print("np.logical_xor(a1 > 0)) :",np.logical_xor(a1 > 0)) 
